...
Current requested scope is **Phase 4 only: complete Async Weather**. Preserve the verified Phase 1 runtime, all Phase 2/3 published IDs and mastery, every saved project/challenge draft, schema-1 compatibility, scoped training data, and runnable export. Add deterministic API fixtures, a clearly labeled optional live capability, modules/async prerequisites, loading/empty/error/offline states, request validation and stale-response protection, behavior tests, and runnable Weather export. React lessons, ecommerce, accounts and publication remain later scope. Stop after Phase 4.

The Phase 3 baseline was verified before changes: 44 unit tests, valid content with seven published Todo topics and 22 drafts, and all 24 browser scenarios. Phase 4 adds eight Weather topics with 40 activities, 16 blanks, 192 questions, and 24 independent challenges. The combined inventory is 15 published topics and 14 drafts. **Phase 4 is complete and accepted (2026-09-14)**: 63 unit tests, content validation, production build, all 33 development browser scenarios and 19 production scenarios passed. Final results and limitations are recorded in docs/HANDOFF.md and docs/PHASES.md. Existing published Todo content and persistence/mastery/runtime foundations have explicit preservation checks.
